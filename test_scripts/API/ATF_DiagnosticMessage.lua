		...
		commonFunctions:newTestCasesGroup("****************************** Test suite III: HMIResponseCheck ******************************")
			...
			-----------------------------------------------------------------------------------------------
				...
				--Description: This test is intended to check when HMI response with ResultCode is valid
					--Result codes: SUCCESS, INVALID_DATA, OUT_OF_MEMORY, TOO_MANY_PENDING_REQUESTS, APPLICATION_NOT_REGISTERED, REJECTED, GENERIC_ERROR, DISALLOWED,DISALLOWED, USER_DISALLOWED, TRUNCATED_DATA
				----------------------------------------------------------------------------------------------
					--Requirement id in JAMA/or Jira ID: SDLAQ-CRS-2642
...
--Begin test suit AllResultCodeCheck
	...
	--Write TEST_BLOCK_I_Begin to ATF log
		commonFunctions:newTestCasesGroup("****************************** Test suite VI: Check all result codes ******************************")

			--Begin test case AllResultCodeCheck5.1
			...
			--End test case AllResultCodeCheck5.1
			------------------------------------------------------------------------------------------------------------

			--Begin test case AllResultCodeCheck5.2
		    --Description: This test is intended to check when this RPC is not present in the policy

				--Requirement id in JAMA/or Jira ID: SDLAQ-CRS-2642
				--Verification criteria: SDL sends DISALLOW to mobile app
				policyTable:checkPolicyWhenAPIIsNotExist()

				--Verification criteria: SDL sends USER_DISALLOW to mobile app
				policyTable:checkPolicyWhenUserDisallowed({"FULL", "LIMITED", "BACKGROUND"})

			--End test case AllResultCodeCheck5.2
			------------------------------------------------------------------------------------------------------------
