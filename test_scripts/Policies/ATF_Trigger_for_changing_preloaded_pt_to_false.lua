...
-- without any changes and updates (APPLINK-16899)
-- stop SDL
...
--///////////////////////////////////////////////////////////////////////////////////////////
-- the value of "preloaded_pt" = true can be in case of MASTER_RESET (APPLINK-16899)
-- send master reset
...
--local preloaded_pt_InModule_configGroupTable = "sqlite3 " .. tostring(config.pathToSDL) .. "policy.sqlite \"SELECT preloaded_pt FROM module_config WHERE rowid = 1\""